...
void main() {
  group('Create records', () {
    ...
    test('Extended Segment Address', () {
      expect(createExtendedSegmentAddressRecord(16 * 0x1200), ":020000021200EA\n");
    });
    ...
    test('Extended Linear Address', () {
      expect(createExtendedLinearAddressRecord(0xFFFF0000), ":02000004FFFFFC\n");
    });
    ...
    test('Start Segment Address', () {
      expect(createStartSegmentAddressRecord(0x0000,0x3800), ":0400000300003800C1\n");
    });
    test('End of file', () {
  ...
  group('Errors when creating records', () {
    test('Data address error', () {
      var data = Uint8List(3);
      expect(() => createDataRecord(0x10030, data), throwsA(TypeMatcher<IHexRangeError>()));
    });

    test('Data size error', () {
      var data = Uint8List(256);
      expect(() => createDataRecord(0x0030, data), throwsA(TypeMatcher<IHexRangeError>()));
    });

    test('Extended Segment Address Range error', () {
      expect(() => createExtendedSegmentAddressRecord(16 * 0x10000), throwsA(TypeMatcher<IHexRangeError>()));
    });
  });
}
